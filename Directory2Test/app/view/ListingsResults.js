        ...
        items: [
            {
                ...
                listeners: {
                    itemtap: function (view, index, item, e) {
                        ...
                        var dealsArray = [];
                        var dealsListArray = [];
                        var deals = record.data.Directory1_Deals;
                        var dealsCount = record.data.DealsCount;

                        var menusArray = [];
                        var menus = record.data.Directory1_Menus;
                        ...
                        tabsArray.push(
                        {
                            ...
                            items: [
                                {
                                    xtype: 'container',
                                    id: 'ListingsDetailsTabPanel_Listings_Logos',
                                    ...
                                    items: [
                                        {
                                            xtype: 'image',
                                            id: 'ListingsDetailsTabPanel_Listings_Logos_Logo',
                                            centered: true,
                                            width: '60px',
                                            height: '60px',
                                        ...
                                        items: [
                                            {
                                                ...
                                                handler: function () {
                                                    ...
                                                    Ext.Ajax.request({
                                                        url: 'http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/Redeem.aspx?Type=Listings&DealId=' + dealId,

                                                        success: function (response) {
                                                            console.log("Success");
                                                            Ext.util.openLink('http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/RedeemSuccess.aspx?Type=Listings&DealId=' + dealId);
                                                        },
                                            ...
                                            },
                                            {
                                                ...
                                                handler: function () {
                                                    ...
                                                    Ext.Ajax.request({
                                                        url: 'http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/Share.aspx?Type=Listings&DealId=' + dealId,

                                                        success: function (response) {
                                                            console.log("Success");
                                                            //Ext.util.openLink('http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/ShareSuccess.aspx?Type=Listings&DealId=' + dealId);
                        ...
                        Ext.getCmp('ListingsDetailsTabPanel_Listings_Logos_Logo').setSrc(record.data.Logo);
