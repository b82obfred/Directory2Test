                    ...
                    itemtap: function (view, index, item, e) {
                                        ...
                                        items: [
                                            {
                                                ...
                                                handler: function () {
                                                    ...
                                                    Ext.Ajax.request({
                                                        url: 'http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/Redeem.aspx?Type=Deals&DealId=' + dealId,

                                                        success: function (response) {
                                                            console.log("Success");
                                                            Ext.util.openLink('http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/RedeemSuccess.aspx?Type=Deals&DealId=' + dealId);
                                                        },
                                            ...
                                            },
                                            {
                                                ...
                                                handler: function () {
                                                    ...
                                                    Ext.Ajax.request({
                                                        url: 'http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/Share.aspx?Type=Deals&DealId=' + dealId,

                                                        success: function (response) {
                                                            console.log("Success");
                                                            //Ext.util.openLink('http://directory1.business2mobile.com/DesktopModules/B2MLocal/Directory1Test/ShareSuccess.aspx?Type=Deals&DealId=' + dealId);
                        ...
                        tabsArray.push(
                        {
                            ...
                            items: [
                                {
                                    xtype: 'container',
                                    id: 'DealsDetailsTabPanel_Listings_Logos',
                                    //style: 'background-color:#1A5496;',
                                    width: '60px',
                                    height: '60px',
                                    layout: { type: 'card' },
                                    items: [
                                        {
                                            xtype: 'image',
                                            id: 'DealsDetailsTabPanel_Listings_Logos_Logo',
                                            centered: true,
                                            width: '60px',
                                            height: '60px',
                        ...
                        Ext.getCmp('DealsDetailsTabPanel_Listings_Logos_Logo').setSrc(record.data.Logo);
